...
function overridejQueryData() {

    $.fn.data_old = $.fn.data;
    $.fn.data = function () {
        let data = this.data_old.apply(this, arguments);
        if (typeof data !== "undefined" && typeof data.frames === "string") {
            data.frames = data.frames.replace(/'/g, '"');
