    ...
    return(
        <section className="main-slider style2">
            <div className="rev_slider_wrapper fullwidthbanner-container" id="rev_slider_one_wrapper" data-source="gallery">
                <div className="rev_slider fullwidthabanner" id="rev_slider_two" data-version="5.4.1">
                    <ul>
                               ...
                               style={{zIndex:"7",whiteSpace:"nowrap"}}>
                                <div className="slide-content left-slide">
                                    <div className="btn-box">
                                        <a className="html5lightbox play-button" title="crystalo Video Gallery" href="https://www.youtube.com/watch?v=p25gICT63ek">
                                            <span className="flaticon-play-button"></span>
                                        </a>
                                        <a className="slide-style2-button" href="#">More About Us</a>
                                    </div>
                                </div>
                            </div>
                               ...
                               style={{zIndex:"7",whiteSpace:"nowrap"}}>
                                <div className="slide-content left-slide">
                                    <div className="btn-box">
                                        ...
                                        <a className="slide-style2-button" href="#">Services We Provide</a>
                                    </div>
                                </div>
                            </div>
                               ...
                               style={{zIndex:"7",whiteSpace:"nowrap"}}>
                                <div className="slide-content left-slide">
                                    <div className="btn-box">
                                        ...
                                        <a className="slide-style2-button" href="#">View Our Projects</a>
                                    </div>
                                </div>
                            </div>
                        </li>
